...
from hpp.pipeline import run_pipeline, PangenomeMappingPipeline
...
def synteny(
    ...
    Example:
        python cli.py synteny \
            ...
            --threads 8
    """
    from hpp.stages.synteny import run_minimap2, build_syntenic_blocks, get_synteny_statistics
    from hpp.models import SyntenicMap
...
def validate(gff: str, target_fasta: str, output: Optional[str]):
    ...
    from hpp.validation.structural import validate_mapped_genes
...
# Register per-stage commands for the Nextflow-orchestrated pipeline.
from hpp.stage_cli import STAGE_COMMANDS  # noqa: E402

for _stage_cmd in STAGE_COMMANDS:
    cli.add_command(_stage_cmd)
