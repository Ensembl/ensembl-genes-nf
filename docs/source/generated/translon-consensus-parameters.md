# Translon Consensus Pipeline Parameters

Generated from `pipelines/translon-consensus/nextflow_schema.json`.
...
| `gencode_fasta` | string |  | yes | Path to gencode FASTA. |
| `gencode_fasta_fai` | string |  | yes | Path to gencode FASTA FAI. |
