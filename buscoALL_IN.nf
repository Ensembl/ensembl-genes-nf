...
include { TOLOWER } from params.modules_path
include { GETSPECIES } from params.modules_path
include { GETGCA } from params.modules_path
include { REFACTORING } from params.modules_path
...
workflow {
	...
	SPECIESOUTDIR (BUSCODATASET.out.dbname, BUSCODATASET.out.busco_dataset)
		...
		BUSCOGENOME (FETCHGENOME.out.output_dir, FETCHGENOME.out.db_name, FETCHGENOME.out.busco_dataset)
        }
        if(params.mode == 'protein'){
                ...
                BUSCOGENOME (FETCHPROTEINS.out.output_dir, FETCHPROTEINS.out.db_name, FETCHPROTEINS.out.busco_dataset)
        }
